...
3) Access the `workbench` named `object-detection-v1742388115424-notebook`.
...
5) In the terminal, run `cd object-detection-v1742388115424` to navigate to your sample app's directory.
